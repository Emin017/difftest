 ...
 *
 * DiffTest is licensed under Mulan PSL v2. You can use this software according to the terms and conditions of the Mulan
...
object DifftestMain extends App {
  (new ChiselStage)
    .execute(args, Seq(ChiselGeneratorAnnotation(() => new DifftestTop)))
  (new ChiselStage).execute(
    args,
    Seq(
      ChiselGeneratorAnnotation(() => new difftest.common.DifftestMem2P(64, 8, 8))
    )
  )
}
