...
remote_bitbang_t::remote_bitbang_t(uint16_t port) : err(0), socket_fd(0), client_fd(0), recv_start(0), recv_end(0)
{
...
void remote_bitbang_t::tick(unsigned char *jtag_tck, unsigned char *jtag_tms, unsigned char *jtag_tdi,
