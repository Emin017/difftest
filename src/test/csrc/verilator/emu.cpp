...
inline EmuArgs parse_args(int argc, const char *argv[])
{
...
#endif // CONFIG_NO_DIFFTEST
    const struct option long_options[] = {{"load-snapshot", 1, NULL, 0},
                                          {"dump-wave", 0, NULL, 0},
    ...
    int o;
    while ((o = getopt_long(argc, const_cast<char *const *>(argv), "-s:C:X:I:T:R:W:hi:r:m:b:e:F:", long_options, &long_index))
           != -1)
    {
        switch (o)
        {
        case 0:
            ...
            case 2:
                ...
                continue;
            case 3:
                args.force_dump_result = true;
                continue;
#ifndef CONFIG_NO_DIFFTEST
            case 4:
                difftest_ref_so = optarg;
                continue;
#endif // CONFIG_NO_DIFFTEST
            case 5:
            ...
            case 17:
                ...
                continue;
            case 18:
                args.footprints_name = optarg;
                continue;
            case 19:
                args.image_as_footprints = true;
                continue;
            case 20:
                args.linearized_name = optarg;
                continue;
            case 21:
                args.enable_waveform = true;
                ...
                continue;
            case 22:
                args.overwrite_nbytes = atoll_strict(optarg, "overwrite_nbytes");
                continue;
            }
            // fall through
        default:
        ...
        case 'C':
            ...
            break;
        case 'X':
            args.fork_interval = 1000 * atoll_strict(optarg, "fork-interval");
            break;
        case 'I':
        ...
        case 'W':
            ...
            break;
        case 'D':
            args.stat_cycles = atoll_strict(optarg, "stat-cycles");
            break;
        case 'i':
            args.image = optarg;
            break;
        case 'r':
            args.gcpt_restore = optarg;
            break;
        case 'b':
...
#include <functional>
std::function<double()> get_sc_time_stamp = []() -> double {
    return 0;
};
